...
public:
    Sphere(Program *program) : _program(program) {
        initialize();
    }
    ...
    void render() {
        ...
        unsigned int modelLoc = glGetUniformLocation(_program->getProgramID(), "model");
        unsigned int viewLoc = glGetUniformLocation(_program->getProgramID(), "view");
        // pass them to the shaders (3 different ways)
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glUniformMatrix4fv(viewLoc, 1, GL_FALSE, &view[0][0]);
        // note: currently we set the projection matrix each frame, but since the projection matrix rarely changes it's often best practice to set it outside the main loop only once.
        _program->setMat4("projection", projection);
...
private:
    ...
    void initialize() {
        ...
        // -------------------------------------------------------------------------------------------
        _program->bind();
        _program->setInt("texture1", 0);
        _program->setInt("texture2", 1);
